...
def list_to_csv(data):
    ...
    writerCSV.to_csv('./conf_meths/project-version-meths.csv', encoding='utf-8')


if __name__ == '__main__':
    ast_csv = "E:/PycharmProjects/DataExtraction/CustomizedAndroid/history/android_base/ast/project/project-version-merge.csv"
    # ast_csv = "E:/PycharmProjects/DataExtraction/CustomizedAndroid/history/android_base/ast/calyx/android11-qpr1-merge.csv"
